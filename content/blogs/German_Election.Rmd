...
german_polls %>% 
  ...
  scale_color_identity(name= "05 Sep 2021", breaks=c("black", "red", "blue", "green", "yellow", "purple"),
  ...
  #Label the graph
  labs(caption = "Source: wahlrecht.de, last updated 05 Sep 2021",
